 ...
 * $Revision: 349 $
 * $Author: bartos $
 * $HeadURL: http://triglav/repos/BuenaVista/Hyperons/NucleonUamDiploma.cpp $
 * $Id: NucleonUamDiploma.cpp 349 2013-05-22 08:09:53Z bartos $
 *
 * @file
 * @brief	UA form factor for nucleons - diploma model
 */
...
TComplex FFactor::ScalarTwo (TComplex t)
{
	...
	TComplex norm,suma;
	norm = (1.-v*v)/(1.-vN*vN);
	suma = norm*norm*norm*norm*norm*norm*(nor[1]*mul[2]*mul[3]*mul[4] +
...
TComplex FFactor::VectorOne (TComplex t)
{
	...
	TComplex norm,suma;
	norm = (1.-v*v)/(1.-vN*vN);
	suma = norm*norm*norm*norm*norm*norm*(nor[2]*mul[1]*mul[2] +
