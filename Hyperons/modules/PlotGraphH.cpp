/**
 * $Date: 2013-10-02 13:45:50 +0200 (Wed, 02 Oct 2013) $
 * $Revision: 384 $
 * $Author: bartos $
 * $HeadURL: http://triglav/repos/BuenaVista/Hyperons/modules/PlotGraphH.cpp $
 * $Id: PlotGraphH.cpp 384 2013-10-02 11:45:50Z bartos $
 *
 * @file
 * @brief	Preview of functions and data, v. hyperon.
 */

#include "PlotGraphH.h"
...
void PlotGraph::viewPlusDataAE (Int_t num, Double_t axisX[], Double_t axisY[], Int_t numD, Double_t axisXD[], Double_t axisYD[], Double_t axisXExl[], Double_t axisXExh[], Double_t axisYEyl[], Double_t axisYEyh[], Char_t const* title) {
	...
	gPad->Modified();
	mgr1->GetXaxis()->SetLimits(-15.,15.);
	mgr1->SetMinimum(0.00001);
	mgr1->SetMaximum(1000.);
	...
	//c[k]->Modified();
	//c[k]->BuildLegend();
	//c[k]->Connect("Closed()", "TApplication", gApplication, "Terminate()");
	++k;	
}
