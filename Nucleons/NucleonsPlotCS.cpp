 ...
 * $Revision: 383 $
 * $Author: bartos $
 * $HeadURL: http://triglav/repos/BuenaVista/Nucleons/NucleonsPlotCS.cpp $
 * $Id: NucleonsPlotCS.cpp 383 2013-10-02 11:45:42Z bartos $
 *
 * @file
 * @brief	Plot of nucleon form factors, v. with cross section data.
 */
