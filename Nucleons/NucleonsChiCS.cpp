 ...
 * $Revision: 361 $
 * $Author: bartos $
 * $HeadURL: http://triglav/repos/BuenaVista/Nucleons/NucleonsChiCS.cpp $
 * $Id: NucleonsChiCS.cpp 361 2013-05-30 12:45:21Z bartos $
 * 
 * @file
 * @brief	Chi2 calculation for nucleon form factors, v. with cross section data.
 */
